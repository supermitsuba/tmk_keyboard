...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LCTL,LALT, FN2,          SPC,                          FN3, RALT,RCTL,     LEFT,DOWN,RGHT,    P0,       PDOT,PENT
    ),
    [1] = KEYMAP(
    ...
    LSFT,NUBS,Z,   X,   C,   V, END, END,   M,   COMM,DOT, SLSH,     RSFT,          VOLU,         P1,  P2,  P3,
    LCTL,LALT, FN2,          SPC,                          FN3, RALT,RCTL,     MPLY,VOLD,MUTE,    P0,       PDOT,BTLD
    ),
};
